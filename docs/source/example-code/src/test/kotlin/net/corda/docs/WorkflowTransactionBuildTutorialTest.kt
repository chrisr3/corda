...
class WorkflowTransactionBuildTutorialTest {
    ...
    fun `Run workflow to completion`() {
        ...
        val nodeBVaultUpdate = nodeB.services.vaultService.updates.first().toFuture()
        ...
        val nodeAVaultUpdate = nodeA.services.vaultService.updates.first().toFuture()
        val secondNodeBVaultUpdate = nodeB.services.vaultService.updates.first().toFuture()
